...
mls_draftkings            = 'https://sportsbook.draftkings.com/featured'
...
## NORTH MAERICAN LINKS :

draft_kings_league_link  = "https://sportsbook.draftkings.com/featured"
fan_duel_league_link     = "https://fanduel.com/featured"
caesars_league_link      = "https://www.caesars.com/sportsbook-and-casino"
...
websites_ligue1_links        = [passionsports_ligue1_link, paris_sportifs_pmu, france_pari_ligue1_link, zebet_ligue1_link,betclic_ligue1_link, winimax_ligue1_link, unibet_ligue1_link, cbet_ligue1_link, mls_draftkings]
...
sports_n_competetitons = defaultdict(list)
...
'atletico de madrid':'athletico madrid',
'barcelona'  :      'barcelona ',
'cádiz'  :               'cadiz',
'cadiz'  :               'cadiz', 
...
'ac milan' :  'ac milan','ac milano' :  'ac milan', 'milan ac' :  'ac milan', 'milan':'ac milan',              
...
EPL_commonName_mapping = {'man utd': 'manchester united','manchester utd': 'manchester united','man city':'manchester city','manchester city':'manchester city','sheff utd':'sheffield united','sheffield utd':'sheffield united' \
        ,'west bromwich albion':'west brom','brighton & hove albion':'brighton','brighton':'brighton','wolverhampton wanderers':'wolves',
...
# MLS_mapping = {}
 ...
 # West MLs conference :
MLS_conference_West_teams = ['Los Angeles FC',' Real Salt Lake', 'Austin FC', 'Colorado Rapids', 'LA Galaxy', 'Portland Timbers'	, 'Minnesota United FC', 'FC Dallas', 'Houston Dynamo FC' \
    ,'Nashville SC', 'Seattle Sounders FC', 'Sporting Kansas Cit', 'San Jose Earthquakes', 'Vancouver Whitecaps FC']  

    # 'los angeles fc',' real salt lake', 'austin fc',' colorado rapids', 'la galaxy', 'portland timbers'	,' minnesota united fc', 'fc dallas', 'houston dynamo fc '\
    # ,'nashville sc', 'seattle sounders fc',' sporting kansas cit', 'san jose earthquakes',' vancouver whitecaps fc'  

#East MLS confersence teams :
MLS_conference_East_teams = ['Columbus Crew', 'Philadelphia Union', 'New York Red Bulls', 'D.C. United', 'Atlanta United FC', 'Chicago Fire FC', 'New York City FC', 'Orlando City SC' \
    , 'New England Revolution', 'FC Cincinnati', 'Toronto FC', 'Inter Miami CF', 'Charlotte FC	', 'CF Montréal']
